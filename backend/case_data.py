"""Mock case narrative for the Recovery Operating Theater demo.
Single failed-payment case with full RL-agent recovery arc.
All timeline positions are t in [0, 1] mapping onto a 90-minute recovery window.
"""
...
CASE_PAYLOAD = {
    ...
    "events": [
        {"t": 0.00, "type": "failure", "severity": "fail", "label": "Issuer declined · 05 DO_NOT_HONOR", "detail": "HDFC issuer refused authorization. Raw ARN trace captured."},
        ...
        {"t": 0.10, "type": "policy_eval", "severity": "info", "label": "Policy evaluated 4 candidate actions", "detail": "Chose WAIT_RETRY — silent re-route beats immediate contact."},
        ...
        {"t": 0.20, "type": "retry_failed", "severity": "fail", "label": "Retry failed · network timeout 5xx", "detail": "Backup rail timed out at switch. Issuer never reached."},
        ...
        {"t": 0.50, "type": "customer", "severity": "ok", "label": "Checkout rendered · UPI preselected", "detail": "Saved VPA riya@okhdfc surfaced as primary."},
        ...
        {"t": 0.70, "type": "intervention", "severity": "info", "label": "SMS with ₹40 cashback dispatched", "detail": "30-minute expiry window attached · trust budget −14."},
    ...
    "recoveryCurve": [
        {"t": 0.00, "p": 0.34}, {"t": 0.06, "p": 0.36}, {"t": 0.10, "p": 0.42},
        {"t": 0.16, "p": 0.40}, {"t": 0.20, "p": 0.31}, {"t": 0.28, "p": 0.47},
        {"t": 0.32, "p": 0.52}, {"t": 0.44, "p": 0.61}, {"t": 0.50, "p": 0.66},
        {"t": 0.58, "p": 0.44}, {"t": 0.66, "p": 0.58}, {"t": 0.70, "p": 0.64},
    ...
    "ghostRuns": [
        {
            ...
            "points": [{"t": 0.0, "p": 0.34}, {"t": 0.2, "p": 0.40}, {"t": 0.4, "p": 0.60}, {"t": 0.6, "p": 0.50}, {"t": 0.8, "p": 0.78}, {"t": 1.0, "p": 0.97}],
        },
        {
            "id": "gr-1", "label": "3× hard retry burst", "prob": 0.22, "chosen": False,
            "reason": "Rejected — issuer velocity lockout risk 0.63, trust burn −34.",
            "points": [{"t": 0.0, "p": 0.34}, {"t": 0.2, "p": 0.30}, {"t": 0.4, "p": 0.24}, {"t": 0.6, "p": 0.22}, {"t": 0.8, "p": 0.22}, {"t": 1.0, "p": 0.22}],
        },
        {
            ...
            "points": [{"t": 0.0, "p": 0.34}, {"t": 0.2, "p": 0.36}, {"t": 0.4, "p": 0.38}, {"t": 0.6, "p": 0.35}, {"t": 0.8, "p": 0.33}, {"t": 1.0, "p": 0.31}],
        },
        {
            ...
            "points": [{"t": 0.0, "p": 0.34}, {"t": 0.2, "p": 0.42}, {"t": 0.4, "p": 0.55}, {"t": 0.6, "p": 0.44}, {"t": 0.8, "p": 0.47}, {"t": 1.0, "p": 0.48}],
        },
        {
            ...
            "points": [{"t": 0.0, "p": 0.34}, {"t": 0.2, "p": 0.50}, {"t": 0.4, "p": 0.62}, {"t": 0.6, "p": 0.68}, {"t": 0.8, "p": 0.70}, {"t": 1.0, "p": 0.71}],
        },
    ],
    "policySnapshots": [
        {
            "t": 0.10, "chosen": "WAIT_RETRY", "confidence": 0.62,
            "stateFeatures": [
        ...
        },
        {
            ...
            "candidates": [
                ...
                {"action": "INCENTIVE_NOW", "q": 0.40, "note": "Premature spend"},
        ...
        },
        {
            ...
            "candidates": [
                ...
                {"action": "AGENT_CALLBACK", "q": 0.20, "note": "Cost ₹85 > margin"},
            ],
        },
    ],
    "stages": [
        {"from": 0.00, "key": "triage", "label": "Failure triage"},
        {"from": 0.10, "key": "silent", "label": "Silent retry"},
        {"from": 0.28, "key": "nudge", "label": "WhatsApp nudge"},
        {"from": 0.50, "key": "watch", "label": "Customer session"},
    ...
    "trustLedger": [
        ...
        {"t": 0.70, "delta": -14, "reason": "SMS + ₹40 incentive"},
    ],
    "riskSignals": [
...
AMBIENT_EVENTS = [
    ...
    {"type": "agent", "severity": "info", "summary": "Policy heartbeat · ε-exploration 0.04"},
    {"type": "issuer", "severity": "warn", "summary": "HDFC issuer decline rate +3.1% (15m window)"},
    {"type": "cohort", "severity": "ok", "summary": "Cohort: 12 of 31 similar failures recovered today"},
    ...
    {"type": "model", "severity": "info", "summary": "Q-network v0.9.3 · drift 0.02 within bounds"},
    {"type": "route", "severity": "ok", "summary": "AXIS backup rail restored · timeout cleared"},
    {"type": "agent", "severity": "info", "summary": "Reward signal logged · counterfactual bank updated"},
]
