...
export const METHODOLOGY_LAYERS = [
  {
    step: '01',
    label: 'Simulator gym',
    detail: 'WedgeRecoveryEnv + CustomerResponseModel — reproducible episodes, no live API training.',
...
export const TRAINING_PIVOTS = [
  ...
  },
  {
    ...
    when: 'v0 wedge split',
    kind: 'scope',
    title: 'One policy per revenue wedge',
    summary:
  ...
  },
  {
    ...
    outcome: 'Adopted Dueling architecture for all wedge trainers; Standard DQN retired.',
    wedges: ['checkout_failed'],
    episode: 2000,
  },
  {
    id: 'net-inr-primary',
  ...
  },
  {
    ...
    summary:
      'Checkout val_net_inr climbs from ~₹7k at ep500 to ~₹12k by ep1500; exploration (ε) still high — policy already near wedge ceiling on fixed val set.',
  ...
  },
  {
    ...
    when: 'Cart benchmark',
    kind: 'finding',
    title: 'Cart wedge beats rules on ghost replay',
    summary:
  ...
  },
  {
    ...
    kind: 'training',
    title: 'Per-wedge HPO mini-runs',
    summary:
      'Six 1,500-episode pilots per wedge over lr, batch_size, gamma, warmup, and per_alpha. Score = peak val_net_inr minus late-drop overfit penalty.',
    outcome: 'Best config per wedge written to eval/results/hpo_{wedge}_best.json before full train.',
    wedges: null,
  },
  {
    ...
    outcome: 'Milestones at 1k, 4k, 10k, 15k, 20k for all four wedges.',
    wedges: null,
    episode: 20000,
  },
  {
  ...
  },
  {
    ...
    wedges: ['cart_abandon', 'subscription_failed'],
  },
];

/** Map wedge id → accent key for charts */
export const WEDGE_CHART_ACCENT = {
